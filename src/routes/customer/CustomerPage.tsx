...
import { Button, Col, DatePicker, Form, Image, Input, Row, Select, Space, Table } from "antd";
        ...
        columns={[
          ...
          },
          {
            ...
            render: (_, record) => {
              return <Space>
                {
                  record.customerImages.map(customerImage => <Image key={customerImage.image.id} src={customerImage?.image?.path} width={100} />)
                }
              </Space>;
            },
          },
